...
#' scale_color_brewer ggplot geom_line labs
...
#' @details
#' Probability distributions are generated using functions that have a name
#' corresponding to the probability distribution that is being used.
#'
