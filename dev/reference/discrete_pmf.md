...
and the remaining PMF is renormalised to sum to one. A non-zero CDF
cutoff additionally trims the tail, removing the part of the
distribution beyond its `1 - cdf_cutoff` quantile.
